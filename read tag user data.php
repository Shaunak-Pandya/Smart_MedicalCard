<?php
	...
	$sql = "SELECT * FROM aadhaar_detail where id = ?";
	$q = $pdo->prepare($sql);
	$q->execute(array($id));
					...
					<tr>
						<td bgcolor="#f9f9f9">
							<table width="452"  border="0" align="center" cellpadding="5"  cellspacing="0">
								...
								<tr bgcolor="#f2f2f2">
									<td align="left" class="lf">Aadhar Card</td>
									<td style="font-weight:bold">:</td>
									<td align="left"><?php echo $data['aadhaar_id'];?></td>
								</tr>
								<tr bgcolor="#f2f2f2">
									<td align="left" class="lf">Name</td>
									<td style="font-weight:bold">:</td>
									<td align="left"><?php echo $data['f_name'];?></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td style="font-weight:bold">:</td>
									<td align="left"><?php echo $data['mobile_no'];?></td>
								</tr>
							</table>
						</td>
					</tr>
