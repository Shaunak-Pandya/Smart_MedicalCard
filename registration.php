...
<html>
	...
	<body>
		...
		<h2 align="center">VIDA |Registration</h2>
		<ul class="topnav">
			...
			<div class="center" style="margin: 0 auto; width:495px; border-style: solid; border-color: #f2f2f2;">
				...
				<form class="form-horizontal" action="insertDB.php" method="post" >
					...
					<div class="control-group">
						...
						<div class="controls">
							<input id="div_refresh" name="aadhar" type="text"  placeholder="" required>
						</div>
					</div>
					<div class="control-group">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input id="div_refresh" name="l_name" type="text"  placeholder="" required>
						</div>
					</div>
					<div class="control-group">
